...
simulates a four-day attack window (January 21--25, 2022, UTC) on a 22-host
...
% TBD: optional stat block (date range histogram, lines/host bar) if you
% want a figure here. Not required by the rubric.
