...
-- Technique: JOIN (4 tables), CASE expressions, GROUP BY, SUM
...
-- Expected: 33 rows. phpsessionclean dominates intranet_server (384 events).
...
-- Technique: JOIN (4 tables), GROUP BY, COUNT DISTINCT, ORDER BY
...
-- Expected: Exfiltration dominates (53K lines, 2 sources), but
